...
## The result file is in "data/Trial/T7_trial_jury.csv"   Total: 344 items
## The result file is in "data/Trial/T8_trial_bench.csv"   Total: items
def T7_T8_trial_jury():
    csv.field_size_limit(sys.maxsize)
    ...
    with open('data/Trial/all_complete_trial.csv', 'rb') as csvfile:
        ...
        print len(juryresult)
        print len(benchresult)
